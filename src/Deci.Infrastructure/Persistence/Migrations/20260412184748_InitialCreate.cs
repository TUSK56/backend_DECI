    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MasterGroupCodes", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MasterTrainers", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IpTrackingEnabled = table.Column<bool>(type: "bit", nullable: false),
                    SessionApprovalRequired = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateLabel = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Start = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: false),
                    End = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GroupCode = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
                    TrainerName = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: false),
                    SessionDate = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: false),
                    SessionLink = table.Column<string>(type: "nvarchar(2048)", maxLength: 2048, nullable: true),
                    RecordingLink = table.Column<string>(type: "nvarchar(2048)", maxLength: 2048, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SessionLogs_Users_CoordinatorUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Deadline = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: true),
                    Status = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SessionFiles_SessionLogs_SessionLogId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MasterGroupCodes_Code",
                table: "MasterGroupCodes",
                column: "Code",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_SessionFiles_SessionLogId",
                table: "SessionFiles",
                column: "SessionLogId");

            migrationBuilder.CreateIndex(
                name: "IX_SessionLogs_CoordinatorUserId",
                table: "SessionLogs",
